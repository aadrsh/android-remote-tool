...
public class SocketActivity2 extends AppCompatActivity implements SensorEventListener, View.OnClickListener {
...
//following tutorial
    ...
    Runnable sendData=new Runnable() {
        ...
        public void run() {
            if(SocketConnected){
                writer.println(fusedOrientation[0]+","+fusedOrientation[1]+","+fusedOrientation[2]+"p");
            }else{
                STATUS="Disconnected";
                runOnUiThread(changeText);
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ip_tv.setText(getIPAddress(true));
        status_tv.setText("Initializing");

        myThread=new Thread(createNconnect);
        myThread.start();
    ...
    class calculateFusedOrientationTask extends TimerTask {
        public void run() {
            ...
            new Thread(sendData).start();
            Log.w("FO",fusedOrientation[0]+","+fusedOrientation[1]+","+fusedOrientation[2]);
        }
    }
